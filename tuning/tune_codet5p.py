...
def load_tokenize_data(args):
    ...
    if os.path.exists(args.cache_data):
        ...
        datasets = load_dataset(
            "code_x_glue_ct_code_to_text", 'python', split="train")
        ...
        def preprocess_function(examples):
            ...
            model_inputs = tokenizer(
                source, max_length=args.max_source_len, padding="max_length", truncation=True)
            labels = tokenizer(target, max_length=args.max_target_len,
...
def main(args):
    ...
    print(
        f"  ==> Loaded model from {args.load}, model size {model.num_parameters()}")
...
if __name__ == "__main__":
    ...
    # Logging and stuff
    parser.add_argument(
        '--save-dir', default="saved_models/summarize_python", type=str)
